...
<div class="container">
    <form action="<?= $_SERVER['SCRIPT_NAME'] ?>" method="post">
        <div class="form-group row">
            <label for="inputName" class="col-sm-4 offset-sm-4 col-form-label"></label>
            <div class="col-sm-4 offset-sm-4">
                <input type="text" class="form-control" name="text" id="inputName" placeholder="">
            </div>
        </div>
        <div class="form-group row">
